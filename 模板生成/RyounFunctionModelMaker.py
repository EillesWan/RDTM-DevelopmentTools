...
open("./Ryoun"+packname+"Pack/behavior_packs/Ryoun"+packname+"/functions/test.mcfunction","w",encoding='UTF-8').write('''tellraw @a {"rawtext":[{"text":"Hello World!\\n§b§lRyounForever!\\n§l§b凌云永存！\\n§b§l凌雲永存！"}]}''')
